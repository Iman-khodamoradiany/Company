...
function DeafultHeader() {
    const {Token  ,header } = useContext(MyContext)
    return (
        <nav className={`flex justify-between items-center z-20 w-full left-[50%] top-[35px] rounded-0 bg-white lg:absolute lg:translate-x-[-50%] lg:translate-y-[-50%]'} mx-auto px-5 py-4 rounded-0 lg:w-[85%]  lg:top-[50px] lg:rounded-xl `} dir="rtl">
