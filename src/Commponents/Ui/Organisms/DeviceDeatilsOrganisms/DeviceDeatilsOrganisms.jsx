...
import RealStateDetailsHeader2 from "../../Molecules/DetailsDeviceMoecules/RealStateDeatilsHeader2"
function DeviceDetailsOrganisms({image,role}) {
    return (
        <>
            <div className=" w-[100%]   flex flex-col  mx-auto">
                <div className=" w-full    ">

                    <RealStateDetailsHeader2 image={image}  />
                
                </div>

                <div className="w-[85%] mx-auto  h-[60vh] flex justify-between ">
                    
                    <ParentUnderHeader role={role}  />
