...
function Header() {
    ...
    return (
        <header onClick={() => setButtonEJ(false)} className="text-center text-[#EDEDED] font-bold flex justify-end h-[100vh] gap-[70px] items-center flex-col bg-contain lg:bg-cover bg-[url(/Background/Photo.png)] bg-cover bg-no-repeat relative w-full flex justify-start items-end">
