...
function Slogan() {
    return (
        <div className="flex justify-start text-[#353535] items-start flex-col gap-3">
            <div className="w-[55%] flex justify-end">
                <Icon Name={'BigLogo'} />
            </div>
            <Text style={'text-[1vw] font-bold'}>تجربه لذت خانه دار شدن سریع و آسان</Text>
            <div className="text-[0.9vw] w-[110%]">
