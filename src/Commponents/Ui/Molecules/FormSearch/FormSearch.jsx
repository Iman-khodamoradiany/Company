    ...
    return(
        <form className="bg-white px-6  text-black flex justify-center items-center flex-col w-11/12 mx-auto rounded-[12px]  py-3">
             <div className="w-full flex justify-between" dir="rtl">
                <Button type={'button'} className={'w-1/2 text-[1.5vw] text-[#353535] border-b-[2px] pb-3 focus:border-b-[#CB1B1B] focus:border-b-[2px]'}>اجاره</Button>
                <Button type={'button'} className={'w-1/2 text-[1.5vw] text-[#353535] border-b-[2px] focus:border-b-[#CB1B1B] focus:border-b-[2px]'}>خرید</Button>
             </div>
