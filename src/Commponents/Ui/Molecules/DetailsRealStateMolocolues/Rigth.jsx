        ...
        <>
            <div className="w-[100%] flex  flex-col gap-2 h-[90%]  ">
                ...
                <div className="w-[100%]  text-[1.5vw] font-semibold text-[#505050] p-1 pt-2   gap-1 justify-end flex">
                   <div className=" flex justify-center items-center gap-1">
                     <Text> بیش از ۴۰۰۰ آگهی‌های فعال</Text>
                    <Icon  Name={"home"}/>
                   </div>
                </div>
                <div className="w-[100%]  justify-end flex  p-2">
                    <Button className=" w-[25%] p-2.5 rounded-[8px] text-[#9E1515] border border-[#9E1515] hover:bg-red-900 "><Text>تماس با ما</Text></Button>
                </div>
            </div>
        </>
    )
